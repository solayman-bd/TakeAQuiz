...
class Quiz(models.Model):
    ...
    num_questions = models.PositiveIntegerField(default=0, validators=[MinValueValidator(0), MaxValueValidator(5)])  
...
class Question(models.Model):
    ...
    def save(self, *args, **kwargs):
        if not (5 <= self.quiz.question_set.count() <= 50):
            raise ValidationError("There should be at least 5 and at most 50 questions.")
        ...
        quiz.num_questions = quiz.question_set.count()
        quiz.save()
